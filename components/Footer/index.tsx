            ...
            >
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                            <div className="mb-12 max-w-[360px] lg:mb-16">
                                ...
                                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                                    Av. de Manoteras, 26, 6º C, 28050 Madrid.
                                </p>
                                <div className="flex items-center">
                                    <a
                                        href="https://twitter.com/ByronLabs"
                                    ...
                                    <a
                                        href="https://www.linkedin.com/company/byronlabs"
                                        aria-label="social-link"
                                        className="mr-6 text-[#CED3F6] hover:text-primary"
                                    >
                ...
                <div className="bg-primary/10 py-8">
                    <div className="container">
                        <p className="text-center text-base text-body-color dark:text-white">
                            © 2023 Byron Labs. All rights reserved.
                        </p>
                    </div>
                </div>
                <div className="absolute right-0 top-14 z-[-1]">
                    <svg width="55" height="99" viewBox="0 0 55 99" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <mask id="mask0_94:899" maskUnits="userSpaceOnUse" x="0" y="0" width="99" height="99">
