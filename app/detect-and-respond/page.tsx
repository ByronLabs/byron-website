    ...
    <>
      <section className="mt-14 py-16 md:py-20 lg:py-28">
        <div className="container">
              ...
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    <span className="mr-2 text-red-500 font-bold text-lg">-</span> Detect and respond to emerging threats before they escalate into crises.
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    <span className="mr-2 text-red-500 font-bold text-lg">-</span> Adjust your cybersecurity strategies to stay one step ahead of evolving threats.
                  </p>
                </div>
              </div>
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    <span className="mr-2 text-red-500 font-bold text-lg">-</span>Partner with us to fortify your cybersecurity defenses and readiness.
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    <span className="mr-2 text-red-500 font-bold text-lg">-</span>Customized cybersecurity solutions to match your unique requirements and capabilities.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="wow fadeInUp" data-wow-delay=".15s">
              <h2 className="text-4xl font-bold text-center">Ensure constant vigilance over your digital assets, with around-the-clock threat detection</h2>
            </div>
          </div>
                ...
                <div className="mb-9">
                  <div className="mb-10 flex items-center">
                    <div className="h-[60px] w-[60px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary flex justify-center">
                      ...
                      >
                        <path fill="currentColor" d="M2 2h20v20H2V2Zm2 2v16h16V4H4Zm14 4v3h-2V8h2Zm-5 2v3h-2v-3h2Zm-5 2v6H6v-6h2Zm10 1v5h-2v-5h2Zm-5 2v3h-2v-3h2Z"/>
                      </svg>
                    </div>
                  ...
                  <div className="mb-10 flex items-center">
                    <div className="h-[60px] w-[60px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary flex justify-center">
                      <svg
                        ...
                        className="fill-current"
                      >
                        <path fill="currentColor" d="M6 22q-.825 0-1.413-.588T4 20v-3h2v3h12v-3h2v3q0 .825-.588 1.413T18 22H6ZM4 11V4q0-.825.588-1.413T6 2h8l6 6v3h-2V9h-5V4H6v7H4Zm-3 4v-2h22v2H1Zm11-4Zm0 6Z"/>
                      </svg>
                    </div>
                    <h3 className="mt-4 ml-4 mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
