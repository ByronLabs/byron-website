              ...
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    ...
                    Detect and respond to emerging threats before they escalate
                    into crises.
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    ...
                    Adjust your cybersecurity strategies to stay one step ahead
                    of evolving threats.
                  </p>
                </div>
              </div>
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    ...
                    Partner with us to fortify your cybersecurity defenses and
                    readiness.
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    <span className="mr-2 text-red-500 font-bold text-lg">
                    ...
                    Customized cybersecurity solutions to match your unique
          ...
          >
            <div className="wow fadeInUp" data-wow-delay=".15s">
              <h2 className="text-4xl font-bold text-center">
                Ensure constant vigilance over your digital assets, with
