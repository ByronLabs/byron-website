                            ...
                            <div className="w-full">
                                <div className="wow fadeInUp" data-wow-delay=".15s">
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span> Do you have the
                                        expertise to identify vulnerabilities and weaknesses in your software?
                                    </p>
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span> Can you actively
                                        hunt down and neutralize potential threats before they exploit your systems?
                                    </p>
                                </div>
                            </div>
                            <div className="w-full">
                                <div className="wow fadeInUp" data-wow-delay=".15s">
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                                        ...
                                        Integrate security seamlessly into your development pipeline with DevSecOps
                                        practices.
                                    </p>
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span>
                                        Add S-SDLC and DevSecOps to ensure security is built into your software from the
                                        ground up.
                                    </p>
                                </div>
                            </div>
                    ...
                    >
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <h2 className="text-4xl font-bold text-center">
                                Forge a secure path to success for your applications with our expertise, safeguarding
                                your code and user data at every step.
                            </h2>
                        </div>
                    </div>
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4 lg:w-1/2">
                            <div
                                ...
                                data-wow-delay=".15s"
                            >
                                <Image src="/images/services/browser_icon_3.svg" alt="about image" fill />
                            </div>
                        </div>
