              ...
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    ...
                    Are regulatory changes keeping you up at night?
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    <span className="mr-2 text-red-500 font-bold text-lg">
                      -
                    </span>{" "}
                    Struggling to manage risks effectively?
                  </p>
                </div>
              </div>
              <div className="w-full">
                <div className="wow fadeInUp" data-wow-delay=".15s">
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                    ...
                    Is your organization facing governance challenges?
                  </p>
                  <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                    <span className="mr-2 text-red-500 font-bold text-lg">
                      -
                    </span>{" "}
                    Worried about data breaches and security incidents?
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="wow fadeInUp" data-wow-delay=".15s">
              <h2 className="text-4xl font-bold text-center">
                We empower our clients to navigate the complexities with
                confidence, offering tailored solutions that minimize risks,
                optimize governance, and ensure regulatory compliance
              </h2>
            </div>
          </div>
              ...
              <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
                <div className="mb-9">
                  ...
                  <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    Ensure your organization adheres to the latest regulatory
                ...
                <div className="mb-9">
                  ...
                  <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    Safeguard your business against unexpected risks with our
                    expert risk assessments. We help you identify, evaluate, and
                    prioritize risks.
                  </p>
                </div>
                <div className="mb-9">
                  ...
                  <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    Be prepared for security incidents with our incident
                    response planning services. We develop customized incident
                    response plans, conduct tabletop exercises, and ensure your
