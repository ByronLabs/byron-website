                            ...
                            <div className="w-full">
                                <div className="wow fadeInUp" data-wow-delay=".15s">
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span> Are you able to
                                        detect and respond to a fast-paced ransomware actor?
                                    </p>
                            ...
                            <div className="w-full">
                                <div className="wow fadeInUp" data-wow-delay=".15s">
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                                        ...
                                        Are you able to detect and respond to a fast-paced ransomware actor?
                                    </p>
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span>
                                        Are you able to detect and respond to a fast-paced ransomware actor?
                    ...
                    >
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <h2 className="text-4xl font-bold text-center">
                                Whatever your situation and capability: Our experts are ready to bring you to the next
                                level!
                            </h2>
                        </div>
                    </div>
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4 lg:w-1/2">
                            <div
                                ...
                                data-wow-delay=".15s"
                            >
                                <Image src="/images/services/cloud.svg" alt="about image" fill />
                            </div>
                        </div>
                            ...
                            <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
                                <div className="mb-9">
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Conduct comprehensive assessments of cloud infrastructure and configurations
                                        (e.g., AWS, Azure, Google Cloud) to identify vulnerabilities and
                                        misconfigurations.
                                    </p>
                                </div>
                                <div className="mb-9">
                                    <div className="mb-10 flex items-center">
                                        <div className="h-[60px] w-[60px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary flex justify-center">
                                            <svg viewBox="0 0 512 512" width="40" height="40" className="fill-current">
                                                <path
                                                    fill="currentColor"
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Let us help you logging and monitoring your cloud infrastructure to detect and
                                ...
                                <div className="mb-9">
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Let us help you to continuously test your cloud infrastructure to ensure that
