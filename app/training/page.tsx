                            ...
                            <div className="w-full">
                                <div className="wow fadeInUp" data-wow-delay=".15s">
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color mb-3">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span> Is your workforce
                                        equipped with the latest cybersecurity skills?
                                    </p>
                                    <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                                        <span className="mr-2 text-red-500 font-bold text-lg">-</span> Struggling to
                                        address specific security challenges or technologies?
                                    </p>
                                </div>
                            </div>
                            <div className="w-full">
                    ...
                    >
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <h2 className="text-4xl font-bold text-center">
                                Expert-led courses are tailored to enhance your cybersecurity resilience.
                            </h2>
                        </div>
                    </div>
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4 lg:w-1/2">
                            <div
                                ...
                                data-wow-delay=".15s"
                            >
                                <Image src="/images/services/training.svg" alt="about image" fill />
                            </div>
                        </div>
                                ...
                                <div className="mb-9">
                                    <div className="mb-10 flex items-center">
                                        <div className="h-[60px] w-[60px] items-center rounded-md bg-primary bg-opacity-10 text-primary flex justify-center">
                                            <svg viewBox="0 0 48 48" width="40" height="40" className="fill-current">
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Master the art of secure software development with our Secure Development
                                        Training courses. Gain the skills to build robust, resilient applications that
                                        stand strong against today&apos;s cyber threats
                                    </p>
                                </div>
                                <div className="mb-9">
                                    <div className="mb-10 flex items-center">
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Learn to harness the full potential of SIEM solutions for proactive threat
                                        detection and effective security incident response.
                                    </p>
                                </div>
                                <div className="mb-9">
                                    <div className="mb-10 flex items-center">
                                        <div className="h-[60px] w-[60px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary flex justify-center">
                                            <svg viewBox="0 0 256 256" width="40" height="40" className="fill-current">
                                                <path
                                                    fill="currentColor"
                                    ...
                                    <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                                        Equip your team to efficiently detect, analyze, and mitigate security incidents,
